...
import "./Profile.css";
import { Form, Input, Button, Cascader, Select, DatePicker } from "antd";
...
const residences = [
  ...
  },
  {
    ...
    children: [
      ...
      { value: "县", label: "县", children: [{ value: "蓟县", label: "蓟县" }] }
    ]
  },
  {
    value: "河北省",
  ...
  mapPropsToFields(props) {
    return {
      ...
      trueName: Form.createFormField({
        ...props.trueName,
        value: props.trueName ? props.trueName.value : ""
      }),
      gender: Form.createFormField({
        ...props.gender,
        value: props.gender !== undefined ? props.gender.value : ""
      }),
      birthday: Form.createFormField({
        ...props.birthday,
        value: props.birthday ? props.birthday.value : null
      }),
      fixedLine: Form.createFormField({
        ...props.fixedLine,
        value: props.fixedLine ? props.fixedLine.value : ""
      }),
      unit: Form.createFormField({
        ...props.unit,
        value: props.unit ? props.unit.value : ""
      }),
      ...
      address: Form.createFormField({
        ...props.address,
        value: props.address ? props.address.value : ""
      }),
      zipcode: Form.createFormField({
        ...props.zipcode,
        value: props.zipcode ? props.zipcode.value : ""
      })
    };
  },
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      fields: {
        ...
        email: {
          value: user && user.profile ? user.profile.email : ""
        },
        trueName: {
          value: user && user.profile ? user.profile.trueName : ""
        },
        gender: {
          value: user && user.profile ? user.profile.gender : ""
        },
        birthday: {
          value:
            user && user.profile
              ? moment(
                  moment(user.profile.birthday).format("YYYY-MM-DD HH:mm:ss"),
                  "YYYY-MM-DD"
                )
              : null
        },
        fixedLine: {
          value: user && user.profile ? user.profile.fixedLine : ""
        },
        unit: {
          value: user && user.profile ? user.profile.unit : ""
        },
        region: {
        ...
        zipcode: {
          value: user && user.profile ? user.profile.zipcode : ""
        }
      }
    };
  ...
  handleSubmit = async e => {
    ...
    this.form.validateFields((err, values) => {
      if (!err) {
        ...
        editAccount(
          Object.assign(
            (user.profile && JSON.parse(JSON.stringify(user.profile))) || {},
            {
              avatar: avatar,
              nickName: fields.nickName.value,
              email: fields.email.value,
              trueName: fields.trueName.value,
              gender: fields.gender.value,
              birthday: fields.birthday.value
                ? fields.birthday.value.unix()
                : "",
              fixedLine: fields.fixedLine.value,
