  ...
  render() {
    ...
    let centent = richContent.map((content, index) => {
      ...
      switch (content.metaType) {
        ...
        case "video":
          result = (
            <StoryVideo index={index} url={content.url} memo={content.memo} />
          );
          break;
        default:
          break;
...
class StoryContentEditBox extends Component {
  render() {
    ...
    if (!this.props.hideDeleteButton) {
      deleteButton = (
        <i
          className="delete-story-content"
          onClick={this.props.deleteContent.bind(
            this,
            this.props.index,
            this.props.metaType
          )}
        ...
        <span>
          <Tooltip title="添加小标题">
            <div
              ...
              onClick={this.props.addContent.bind(
                this,
                this.props.index,
                "header"
              )}
