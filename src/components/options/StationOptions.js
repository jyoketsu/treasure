      ...
      >
        ...
        >
                ...
                <div className="options-menu">
                  {nowStation && nowStation.role && nowStation.role <= 2
                    ? [
                        ...
                        <div
                          key="plugin"
                          className={pathname === "plugin" ? "active" : ""}
                        >
                          <i
                            style={{
                              backgroundImage:
                  ...
                  {nowStation && nowStation.role && nowStation.role <= 3
                    ? [
                        ...
                        <div
                          className={pathname === "memberList" ? "active" : ""}
                          key="memberlist"
                        >
                          <i
                            style={{
          ...
          <div className="options-content">
            ...
            ></Route>
            <Route
              path={`${match.path}/editChannel`}
              component={EditChannel}
            ></Route>
            <Route
              path={`${match.path}/addPlugin`}
              component={AddPlugin}
            ></Route>
            <Route
              path={`${match.path}/pluginOptions`}
              component={PluginOptions}
            ></Route>
            <Route
              path={`${match.path}/createPlugin`}
              component={CreatePlugin}
            ></Route>
            <Route
              path={`${match.path}/pluginSystem`}
