...
const mapDispatchToProps = dispatch => ({
  login: params => dispatch({ type: LOGIN, payload: api.auth.login(params) })
});
      ...
      <div className="login">
        <div className="login-box">
          <div
            ...
            style={{
              backgroundImage:
                nowStation && nowStation.logo ? `url(${nowStation.logo})` : ""
            }}
          ></div>
          <Form onSubmit={this.handleSubmit} className="login-form">
            ...
            <Form.Item>
              ...
              <Link className="login-form-forgot" to="/account/reset">
                忘记密码
              </Link>
              <Button
                type="primary"
    ...
    if (nextProps.user && !nextProps.user.isGuest) {
      ...
      if (!redirect) {
        let nowStation = nextProps.nowStation
          ...
          : sessionStorage.getItem("STATION_INFO")
